...
def main():
    ...
    print(f"\\n💾 상세 분석 결과 저장 중...")
    try:
        excel_path = analyzer.export_detailed_analysis_to_excel(records, target_scenario, nasdaq_data)
